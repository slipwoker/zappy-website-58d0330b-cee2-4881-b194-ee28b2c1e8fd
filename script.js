document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('input', function (e) {
    ...
    if (field.classList.contains('field-error')) {
      ...
      const wrapper = field.closest('.form-group, .field-wrapper') || field.parentNode;
      const errorMsg = wrapper.querySelector('.form-error-message');
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '58d0330b-cee2-4881-b194-ee28b2c1e8fd',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '58d0330b-cee2-4881-b194-ee28b2c1e8fd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '58d0330b-cee2-4881-b194-ee28b2c1e8fd';
